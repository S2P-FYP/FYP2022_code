...
public class newClass extends AppCompatActivity {
    static String[] classes = new String[]{"beach","mountain","hotel","sabarmati","VR video","Taj Mahal"};//Available classes to match/map
    static int maxPos=0;
    ...
    public void transferToVR_video(){
        Intent VR_v=new Intent(newClass.this,VR_play.class);
        startActivity(VR_v);
    }
}